...
To install on Ubuntu and other Debian-family Linuxes:
    ...
    $ sudo apt-get install git make python3-pip python3-venv
    $ sudo apt-get install xdg-user-dirs python3-pyatspi pulseaudio-utils ffmpeg
    $ sudo apt-get install fonts-roboto python3-qtpy
